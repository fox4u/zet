...
/* Module Version: 5.7 */
/* E:\lscc\diamond\3.14\ispfpga\bin\nt64\scuba.exe -w -n pll2 -lang verilog -synth synplify -bus_exp 7 -bb -arch sa5p00 -type pll -fin 25 -fclkop 50 -fclkop_tol 0.0 -fclkos 50 -fclkos_tol 0.0 -phases 83.08 -fclkos2 12.5 -fclkos2_tol 0.0 -phases2 0 -phase_cntl STATIC -lock -sticky -fb_mode 1 -fdc D:/vm/share/zet_latest/boards/i5/syn/kotku_clarity/pll2/pll2.fdc  */
/* Fri Oct 24 15:49:05 2025 */


`timescale 1 ns / 1 ps
module pll2 (CLKI, CLKOP, CLKOS, CLKOS2, LOCK)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
    output wire CLKOS;
    output wire CLKOS2;
    ...
    defparam PLLInst_0.CLKOS2_CPHASE = 51 ;
    ...
    defparam PLLInst_0.CLKOS2_DIV = 52 ;
    ...
    EHXPLLL PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOP_t), .PHASESEL1(scuba_vlo), 
        ...
        .CLKOS3(), .LOCK(LOCK), .INTLOCK(), .REFCLK(REFCLK), .CLKINTFB())
             /* synthesis FREQUENCY_PIN_CLKOS2="12.500000" */
    ...
    // exemplar begin
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS2 12.500000
