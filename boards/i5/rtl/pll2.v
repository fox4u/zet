...
/* Module Version: 5.7 */
/* E:\lscc\diamond\3.14\ispfpga\bin\nt64\scuba.exe -w -n pll2 -lang verilog -synth synplify -bus_exp 7 -bb -arch sa5p00 -type pll -fin 25 -fclkop 50 -fclkop_tol 0.0 -fclkos 50 -fclkos_tol 0.0 -phases 83.08 -fclkos2 25 -fclkos2_tol 0.0 -phases2 0 -fclkos3 12.5 -fclkos3_tol 0.0 -phases3 0 -phase_cntl STATIC -lock -sticky -fb_mode 1 -fdc D:/vm/share/zet_latest/boards/i5/syn/kotku_clarity/pll2/pll2.fdc  */
/* Sat Dec 06 09:11:09 2025 */
...
module pll2 (CLKI, CLKOP, CLKOS, CLKOS2, CLKOS3, LOCK)/* synthesis NGD_DRC_MASK=1 */;
    ...
    defparam PLLInst_0.CLKOS3_CPHASE = 51 ;
    defparam PLLInst_0.CLKOS2_FPHASE = 0 ;
    defparam PLLInst_0.CLKOS2_CPHASE = 25 ;
    ...
    defparam PLLInst_0.CLKOS3_DIV = 52 ;
    defparam PLLInst_0.CLKOS2_DIV = 26 ;
    ...
    EHXPLLL PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOP_t), .PHASESEL1(scuba_vlo), 
        ...
        .CLKOS3(CLKOS3_t), .LOCK(LOCK), .INTLOCK(), .REFCLK(REFCLK), .CLKINTFB())
             /* synthesis FREQUENCY_PIN_CLKOS3="12.500000" */
             /* synthesis FREQUENCY_PIN_CLKOS2="25.000000" */
    ...
    // exemplar begin
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS3 12.500000
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS2 25.000000
