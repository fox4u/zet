...
vsim -suppress 3009 -t ps -voptargs=+acc -L work -L pmi_work -L ovi_ecp5u  test_kotku
...
add wave -label bp  -hex kotku/zet/core/exec/regfile/r\[5\]
...
add wave -label led_ext_   -hex kotku/led_ext_
